...
SELECT NAME,
	...
	FROM kecheng
	GROUP BY NAME
SELECT name,sum(case score when course = '语文' then score else 0 end) 语文,sum(case score when course = '数学' then score else 0 end) 数学,sum(case score when course = '物理' then score else 0 end) 物理
FROM kecheng
GROUP BY name
```
*******
