...
# 数据库
### 流行的数据库
1. 关系型数据库：oracle,mysql,mariadb,db2,sqlserver,sybase  
2.  no-sql数据库：redis,mangodb,hbase
********************************
### ORACLE
###### 安装及配置ORACLE
1. 安装oracle
...
1. 必须包含在单引号中而且大小写敏感。
2. 可以包含任意的有效的日期格式。
![日期格式.png](https://upload-images.jianshu.io/upload_images/10942635-3efd9587032b21c7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

3. 数字格式如下：
![数字格式.png](https://upload-images.jianshu.io/upload_images/10942635-c70ac36be264d195.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
### 行列转换
就是将形如下表：
![未行列转换.png](https://upload-images.jianshu.io/upload_images/10942635-355533a48281c29c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
转换成形如此表：
![未行列转换.png](https://upload-images.jianshu.io/upload_images/10942635-ca2b30990d79caa3.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
方法：
```
SELECT NAME,
