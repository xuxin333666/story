...
public class TimeHandlerCgLib<T> implements MethodInterceptor {
    private T t;
...
public class UserServiceTest {
    ...
    public void test3() {
        ...
        TimeHandlerCgLib handler = new TimeHandlerCgLib<>();
        UserServiceImpl proxy = (UserServiceImpl)handler.getInstance(userService);
        proxy.query();
    }
